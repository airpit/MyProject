...
public class AndroidVersionAdapter extends BaseAdapter implements TitleProvider {
	...
	private static final String[] names = {"우리가족보드","이웃가족보드"};
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if(convertView == null) {
			if(position == 1){
				convertView = mInflater.inflate(R.layout.neighbor_story, null);
			}else if(position == 0){
				convertView = mInflater.inflate(R.layout.family_story, null);
			}else{
