...
<link href='css/wishList/wishListModify.css' rel='stylesheet'>
<script src="http://code.jquery.com/jquery-1.11.3.min.js"></script>
<script src="js/wishList/wishListModify.js"></script>
<title>소망상자 수정하다</title>
</head>
<body>
					...
					<div id="wish-list-board-info">
						<form id="wish-list-form">
							...
							<div id="wish-list-board-content">
								<!-- 작성자 이름, 작성 날짜 -->
								<div id="wish-list-modify-name-date">
									<input type='text' id="modify-name" class='wish-list-modify-text' value="김철연" readonly/>
									<span id="modify-date-name">작성날짜 : </span>
									<input type='text' id="modify-date" class="wish-list-modify-text" value="2015-07-24" readonly/>
								</div>
								<!-- 소망상자의 제목  -->
								<div id='wish-list-modify-title'>
