     ...
     <div class="modal-content">
        ...
        <div class="modal-body" style="padding:20px 30px;">
          ...
          <!-- 아이디 -->          
            ...
            <div class="col-sm-10">
           		<input type="text" class="form-control" id="Id" name="joinId" placeholder="아이디를 입력하세요">
        	</div>
        	</div>
          ...
          <!-- 비밀번호 -->          
            <div class="form-group">
              ...
              <div class="col-sm-10">
              	<input type="password" class="form-control" id="Pw" name="joinPassword" placeholder="비밀번호를 입력하세요">
              </div>
            </div>
          ...
          <!-- 이름 -->
              ...
              <div class="col-sm-10">
              	<input type="text" class="form-control" id="Name" name="joinName" placeholder="이름을 입력하세요">
              </div>
            </div>
           ...
           <div class="form-group">
              ...
              <div class="col-sm-3">
              	<input type="tel" class="form-control" id="Phone-1" name="joinPhoneNum1">
              </div>
              
              <div class="col-sm-3">
              	<input type="tel" class="form-control" id="Phone-2" name="joinPhoneNum2">
              </div>
             
              <div class="col-sm-3">
              	<input type="tel" class="form-control" id="Phone-3" name="joinPhoneNum3">
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
              	<input type="text" class="form-control" id="userEmail" name="joinEmail" placeholder="이메일을 입력하세요" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
              </div>
