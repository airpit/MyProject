	...
	public FamilyDiaryViewVO[] selectDiaryInfo(String familyDiaryCode)
	{
		...
		try
		{
			...
			while(rs.next())
			{
				...
				list.add(new FamilyDiaryViewVO(familyDiaryCode,familyHomeCode,familyDiaryDate,memberNickname,familyDiaryPartDate,sotongContentsCode,contents,emoticonName,emoticonRoute,imageName,imageWrittenDate));
			}
		}
