...
public int insert(String sotongContentsCode,String senderCode,String receiverCode,String letterTitle,Date sendDate)
{
	...
	{date=new Date();
		...
		pstmt.setString(6,format(sendDate));
...
public int update(String letterCode,String sotongContentsCode,String senderCode,String receiverCode,String letterTitle,Date sendDate)
{
	int rowNum=0;
	...
	try
	{
		...
		pstmt.setString(5, format(sendDate));
...
public int update(String letterCode,LetterVO infoVo)
{
	...
	try
	{
		...
		pstmt.setString(5, format(infoVo.getSendDate()));
		pstmt.setString(6, letterCode);
		rowNum=pstmt.executeUpdate();
	}
	catch(SQLException se)
...
public LetterVO select(String letterCode)
{
	...
	try
	{
		...
		infoVo.setSendDate(changeDate(rs.getString("send_date")));
